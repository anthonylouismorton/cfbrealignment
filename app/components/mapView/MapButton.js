    ...
    <div className='menu-container z-10 flex justify-end pr-1 lg:pr-2'>
      <div>
        <button
         ...
         >
          <h1 className='pr-2 mb-5 text-[8px] sm:text-[8px] md:text-[9px] lg:text-[10px] xl:text-[11px] 2xl:text-[12px]' style={{color: 'white', letterSpacing: '3px', transform: 'rotate(180deg)', writingMode: 'vertical-lr', lineHeight: '1.2'}}>
            LIST
          </h1>
        </button>
      </div>
