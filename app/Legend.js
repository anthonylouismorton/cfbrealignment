...
function Legend({ activeConferences }) {
  return (
    <div>
      <h2 className="text-center mb-1 xl:mb-2 text-[6px] text-[8px] md:text-[10px] lg:text-[12px] xl:text-[16px] 2xl:text-[20px] font-semibold text-white">CONFERENCES</h2>
      <div id="legend">
        {activeConferences && activeConferences.map((conference, index) => (
          <div key={index} className="legend-item flex items-center mb-2">
            ...
            ></div>
            <div className="legend-label text-[7px] md:text-[8px] lg:text-[10px] xl:text-[14px] 2xl:text-[16px] text-white">
