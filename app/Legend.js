...
function Legend({ activeConferences }) {
  return (
    <div>
      <h2 className="text-center mb-1 xl:mb-2 text-[6px] sm:text-[8px] md:text-[10px] lg:text-[15px] xl:text-[17px] 2xl:text-[20px] font-semibold text-white">CONFERENCES</h2>
      <div id="legend">
        {activeConferences && activeConferences.map((conference, index) => (
          <div key={index} className="legend-item flex items-center mb-2">
            ...
            ></div>
            <p className="legend-label text-[6px] sm:text-[6px] md:text-[8px] lg:text-[13px] lg:leading-[13px] xl:text-[14px] 2xl:text-[16px] text-white">
